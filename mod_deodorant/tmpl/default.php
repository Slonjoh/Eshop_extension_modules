...
<div class="product-options">
    <form id="eshop-form" class="eshop-form">
        <select id="deodorant" name="product_id" onchange="updateForm()">
            <option value="" data-price="0">--- Select Deodorant Scent---</option>
...
function updatePrice() {
    var select = document.getElementById('deodorant');
