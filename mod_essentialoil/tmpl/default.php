...
<div class="product-options">
    <form id="eshop-form" class="eshop-form">
        <select id="essentialoil" name="product_id" onchange="updateForm()">
            <option value="" data-price="0">--- Select Essential Oil Scent---</option>
...
function updatePrice() {
    var select = document.getElementById('essentialoil');
