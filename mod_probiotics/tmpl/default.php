...
<div class="product-options">
    <form id="eshop-form" class="eshop-form">
        <select id="probiotics" name="product_id" onchange="updateForm()">
            <option value="" data-price="0">--- Select Probiotics Strain---</option>
...
function updatePrice() {
    var select = document.getElementById('probiotics');
