...
<div class="product-options">
    <form id="eshop-form" class="eshop-form">
        <select id="category_name" name="product_id" onchange="updateForm()">
...
function updateForm() {
    ...
    if (productId) {
        ...
        button.setAttribute('onclick', `addToCart(${productId}, ${quantity}, 'https://yourdomain.com/', '', 'popout', '/index.php/shops/shopping-cart', 'Item added to cart. Please refresh page.')`);
