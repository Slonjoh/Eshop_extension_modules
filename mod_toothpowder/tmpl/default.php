...
<div class="product-options">
    <form id="eshop-form" class="eshop-form">
        <select id="toothpowder" name="product_id" onchange="updateForm()">
            <option value="" data-price="0">--- Select Tooth Powder Type---</option>
...
function updatePrice() {
    var select = document.getElementById('toothpowder');
